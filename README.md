...
If you want to install and run our project locally, make sure that [Docker](https://www.docker.com/get-started) is installed. After that, create a `.env` file with the required variables and run:

...
PHRASES = [
    'Отметила все на календаре — смотри, как это смотрится в масштабе твоей жизни. Захочешь еще один — пиши /calendar',
    'Смотри, как это выглядит в рамках твоей жизни. Для нового календаря нажми /calendar', 
    'Нанесла даты на календарь. Нужен еще один календарь — пиши /calendar', 
    'Смотри — выглядит как полноценная часть твоей жизни. Хочешь сделать еще один календарь? Пиши /calendar', 
    'Нарисовала твой новый календарь. Для нового календаря — пиши /calendar', 
]
